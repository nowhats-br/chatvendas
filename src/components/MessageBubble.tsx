...
import { Check, CheckCheck, Clock, Download, File, ShoppingCart } from 'lucide-react';
  ...
  if (message.message_type === 'system') {
    return (
      <div className="flex justify-center my-2">
        <div className="text-xs text-gray-500 dark:text-gray-400 bg-gray-200 dark:bg-gray-700 rounded-full px-3 py-1 flex items-center space-x-2">
